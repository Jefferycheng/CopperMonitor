using uServeCore.CopperMonitor.Api.Apis;
using uServeCore.CopperMonitor.Api.BackgroundServices;
using uServeCore.CopperMonitor.Api.Middlewares;
...
using uServeCore.CopperMonitor.Infrastructure.ExternalServices;
...
app.MapGet("/", () => "uServeCore.CopperMonitor is running.");
